      ...
      <div className="content-shell py-8 sm:py-10">
        <div className="flex flex-col items-center gap-4 text-center">
          <a href="https://www.saimless.com" target="_blank" rel="noreferrer" className="group flex items-center gap-2.5">
            <img src={saimlessLogo} alt="SAImless" className="h-7 w-7 object-contain opacity-70 transition-opacity group-hover:opacity-100" />
            <span className="font-brand text-sm font-bold text-foreground/80 transition-colors group-hover:text-foreground">
